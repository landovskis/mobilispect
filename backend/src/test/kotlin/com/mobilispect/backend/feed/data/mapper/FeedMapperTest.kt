...
class FeedMapperTest {
    ...
    fun `toDomain should convert entity to domain model with all fields`() {
        // Given
        val now = Instant.now()
        val regionEntity1 = MetropolitanRegionEntity(
            regionOnestopId = "r-dpz8-sf",
            name = "San Francisco Bay Area"
        )
        val regionEntity2 = MetropolitanRegionEntity(
            regionOnestopId = "r-9q5-sandiego",
            name = "San Diego"
        )
