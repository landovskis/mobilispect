...
/**
 * Value class for Agency identifiers using Onestop ID format. Ensures type safety and prevents ID
...
value class AgencyId(val value: String) {
  ...
  companion object {
    /**
     * Creates an AgencyId from FeedId and GTFSAgencyId components. Constructs the Onestop ID in the
     * format: o-{feedId}-{gtfsAgencyId}
     */
