...
class TripUpdateEntity(
  ...
  @Column(name = "vehicle_id", length = 128) val vehicleId: String? = null,
  @Column(name = "timestamp", nullable = false) val timestamp: Instant,
  @Column(name = "delay") val delay: Int? = null,
  @Column(name = "schedule_relationship", length = 32) val scheduleRelationship: String? = null,
