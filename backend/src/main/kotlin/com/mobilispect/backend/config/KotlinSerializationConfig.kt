 ...
 *
 * This configuration creates a custom JSON instance that ignores unknown keys
 * from API responses, preventing deserialization errors when the API schema
 * evolves or contains fields we don't use.
 */
@Configuration
class KotlinSerializationConfig {
     ...
     *
     * This builder is configured to ignore unknown JSON keys, which is necessary
     * for Transit.land API responses that may contain extra fields.
     */
    @Bean
