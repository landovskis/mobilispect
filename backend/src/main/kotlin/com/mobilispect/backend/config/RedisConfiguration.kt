 ...
 *
 * Task T009: Configure Redis for transient progress data Task T096: Add Redis caching for agency
...
class RedisConfiguration : org.springframework.cache.annotation.CachingConfigurer {
  ...
  companion object {
    ...
    /**
     * Cache version - increment this when Jackson serialization config changes to automatically
     * invalidate incompatible cached data.
     */
  ...
  /**
   * Configure cache manager with specific TTLs for different cache types. Task T096: Agency and
   * frequency queries cached for 24 hours.
   *
  ...
  /**
   * Error handler for Redis cache operations. Logs serialization errors and allows the application
   * to continue by falling back to direct queries.
   */
