...
import com.mobilispect.backend.transitanalysis.api.dto.StopDTO
import com.mobilispect.backend.transitanalysis.api.dto.StopSummaryDTO
...
class StopQueryService(
     ...
     */
    @Cacheable(value = [RedisConfiguration.FREQUENCY_CACHE], key = "'stop_' + #stopId")
     ...
     */
    @Cacheable(value = [RedisConfiguration.FREQUENCY_CACHE], key = "'feed_stops_' + #feedId + '_' + #pageable.pageNumber")
     ...
     */
    @Cacheable(value = [RedisConfiguration.FREQUENCY_CACHE], key = "'feed_active_stops_' + #feedId + '_' + #pageable.pageNumber")
     ...
     */
    @Cacheable(value = [RedisConfiguration.FREQUENCY_CACHE], key = "'feed_stations_' + #feedId + '_' + #pageable.pageNumber")
     ...
     */
    @Cacheable(value = [RedisConfiguration.FREQUENCY_CACHE], key = "'feed_stop_count_' + #feedId")
     ...
     */
    @Cacheable(value = [RedisConfiguration.FREQUENCY_CACHE], key = "'feed_active_stop_count_' + #feedId")
