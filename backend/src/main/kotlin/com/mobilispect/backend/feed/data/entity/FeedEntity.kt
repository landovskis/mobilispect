...
class FeedEntity(
  ...
  @Column(name = "spec_type", nullable = false, length = 16) var specType: FeedSpecType,
  @Column(name = "download_url", nullable = false, columnDefinition = "TEXT")
  var downloadUrl: String,
  @Column(name = "static_feed_url", columnDefinition = "TEXT") var staticFeedUrl: String? = null,
  @Column(name = "realtime_feed_url", columnDefinition = "TEXT")
  var realtimeFeedUrl: String? = null,
  @Column(name = "operator_name", length = 255) var operatorName: String? = null,
  @Column(name = "current_version_sha1", length = 40) var currentVersionSha1: String? = null,
  @Column(name = "last_checked_at") var lastCheckedAt: Instant? = null,
  @Column(name = "last_updated_at") var lastUpdatedAt: Instant? = null,
  @Column(name = "last_discovered_at") var lastDiscoveredAt: Instant? = null,
  @Column(name = "status", nullable = false, length = 16) var status: FeedStatus,
