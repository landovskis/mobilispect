...
interface FeedImportRepository : JpaRepository<FeedImport, ImportId> {
   ...
   *
   * This method is needed because Hibernate's findById doesn't properly convert the ImportId value
   * class for ID lookups. Use this instead of findById(ImportId).
   */
  ...
  fun findAllByFeedIdOrderByStartedAtDesc(feedId: String, pageable: Pageable): Page<FeedImport>
