 ...
 *
 * Task T041: Create FeedUpdateScheduler for daily checks
 * Per FR-013: System MUST check all configured regions daily for feed updates
 *
 ...
 *
 * The scheduler uses FeedVersionService for SHA-1 hash comparison and
 * FeedImportService for triggering automatic imports when changes are detected.
 */
@Service
class FeedUpdateScheduler(
    ...
    /**
     * Check all regions with automatic updates enabled for feed updates.
     * Runs daily at 2:00 AM (configurable via cron expression).
     *
