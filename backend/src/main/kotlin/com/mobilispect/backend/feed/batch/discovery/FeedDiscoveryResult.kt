 ...
 *
 * This data class aggregates information from both the OperatorFeedReader (region data)
 ...
 *
 * Combines the outputs from OperatorFeedReader and TransitLandMetadataService
