...
/**
 * Value class for GTFS agency identifiers from agency.txt files. Ensures type safety and prevents
 * confusion with Transitland Onestop agency IDs.
 *
 * This represents the raw agency_id from GTFS feeds, which is different from the Transitland
 * Onestop ID format (o-geohash-name).
 *
