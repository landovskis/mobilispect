...
class MetropolitanRegion(
  ...
  @AttributeOverride(
    name = "value",
    column = Column(name = "region_onestop_id", nullable = false, updatable = false, length = 255),
  )
  var regionOnestopId: RegionId = RegionId(""),
  @Column(nullable = false, length = 255) var name: String = "",
  @Column(name = "adm0_name", nullable = true, length = 255) var adm0Name: String? = null,
  @Column(name = "adm1_name", nullable = true, length = 255) var adm1Name: String? = null,
