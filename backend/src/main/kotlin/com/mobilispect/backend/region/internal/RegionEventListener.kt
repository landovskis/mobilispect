 ...
 *
 * This listener handles events published by other modules (like Feed discovery) and performs
 * region-related operations within proper module boundaries.
 *
 ...
 */
@Component
internal class RegionEventListener(private val regionRepository: MetropolitanRegionRepository) {
  ...
  fun handleRegionDiscovered(event: RegionDiscoveredEvent) {
    ...
    val existingRegion = regionRepository.findByRegionOnestopId(event.regionId).orElse(null)
