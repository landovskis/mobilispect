 ...
 *
 * Provides data access methods for route variants using domain models and type-safe value class IDs.
...
interface RouteVariantRepository {
     ...
     */
    fun findByRouteIdAndDirectionId(routeId: RouteId, directionId: Int, pageable: Pageable): Page<RouteVariant>

    /**
     * Find active variants for a specific route and direction.
     */
    fun findByRouteIdAndDirectionIdAndActive(routeId: RouteId, directionId: Int, pageable: Pageable): Page<RouteVariant>
     ...
     */
    fun findByFirstSeenBetween(after: Instant, before: Instant, pageable: Pageable): Page<RouteVariant>
     ...
     */
    fun findByFirstStopIdAndLastStopId(firstStopId: String, lastStopId: String, pageable: Pageable): Page<RouteVariant>
     ...
     */
    fun existsByRouteIdAndFirstStopIdAndLastStopId(routeId: RouteId, firstStopId: String, lastStopId: String): Boolean
