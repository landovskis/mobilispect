 ...
 *
 * Combines a route variant with stop location data to enable
 * stop spacing calculation between consecutive stops.
 */
 ...
 *
 * Contains individual StopSpacing records for each consecutive stop pair
 * along the route variant.
 */
data class StopSpacingBatch(
    val spacings: List<StopSpacing>
)
