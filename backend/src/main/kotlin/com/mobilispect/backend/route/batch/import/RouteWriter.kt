 ...
 *
 * The writer is transactional - all routes in a chunk are saved atomically.
...
class RouteWriter(
    ...
    private fun recordMetrics(processed: Int, created: Int, updated: Int) {
        ...
        stepExecution?.jobExecution?.executionContext?.putInt("routesProcessed", cumulativeRoutesProcessed)
