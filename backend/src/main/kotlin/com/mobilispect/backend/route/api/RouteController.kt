...
@RestController
@RequestMapping("/api")
class RouteController(private val routeQueryService: RouteQueryService) {

  @GetMapping("/agencies/{agencyId}/routes")
  fun getRoutesByAgency(@PathVariable agencyId: String, pageable: Pageable): Page<RouteDTO> =
