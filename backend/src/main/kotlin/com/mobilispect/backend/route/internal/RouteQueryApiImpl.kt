 ...
 *
 * Bridges the Route module API to the underlying repository layer. This implementation is internal
 * to the route module and should not be accessed directly by other modules.
 */
@Component
internal class RouteQueryApiImpl(private val routeRepository: RouteRepository) : RouteQueryApi {
