 ...
 *
 * Stores the longest continuous section of stops shared by ALL variants in a given direction
 * for a specific route. This is different from CommonSection which represents pairwise overlaps.
 */
@Entity
