 ...
 * domain layer uses Route with type-safe RouteId IDs.
 */
@Entity
@Table(name = "routes")
class RouteEntity(
  ...
  @Column(name = "color", length = 6) var color: String? = null,
  @Column(name = "text_color", length = 6) var textColor: String? = null,
