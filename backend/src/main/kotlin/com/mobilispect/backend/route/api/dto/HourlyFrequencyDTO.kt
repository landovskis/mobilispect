 ...
 *
 * Represents service frequency metrics in 1-hour intervals (00:00-01:00, 01:00-02:00, ...,
 * 23:00-24:00). This provides finer granularity than the standard TimePeriod-based frequency data.
 *
 ...
 * @property averageHeadwayMinutes Average time in minutes between consecutive trips, null if
 *   irregular
 ...
 *
 * Used when displaying route-level frequency patterns, combining metrics from all variants
 * operating on the route during each hour.
 *
 * @property routeId Onestop ID of the route
 * @property serviceDate ISO-formatted date string (e.g., "2025-01-15")
 * @property hourOfDay Hour of day (0-23) when this frequency applies
 * @property averageHeadwayMinutes Average time in minutes between consecutive trips across all
 *   variants, null if irregular
