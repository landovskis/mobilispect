 ...
 *
 * Combines parsed GTFS route data with feed context needed for
 * generating route onestop IDs.
 *
 ...
 *
 * This is the output type for the RouteProcessor, containing routes
 * converted from GTFS data to domain models with TransitLand-compatible
 * onestop IDs.
 *
