...
class FrequencyEntity(
  ...
  @Column(name = "average_headway_minutes") val averageHeadway: Double? = null,
  @Column(name = "min_headway_minutes") val minHeadway: Double? = null,
  @Column(name = "max_headway_minutes") val maxHeadway: Double? = null,
  @Column(name = "trip_count", nullable = false) val tripCount: Int,
  @Column(name = "is_irregular", nullable = false) val isIrregular: Boolean,
  @Column(name = "calculated_at", nullable = false) val calculatedAt: Instant,
