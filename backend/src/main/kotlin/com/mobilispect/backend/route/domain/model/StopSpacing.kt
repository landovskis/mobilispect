 ...
 *
 * Tracks the spacing between each pair of consecutive stops along a route variant's path.
 * This allows analysis of stop spacing patterns and identification of service gaps.
 *
...
class StopSpacing(
    ...
    @Column(name = "from_stop_id", nullable = false, length = 64)
    val fromStopId: String,

    @Column(name = "to_stop_id", nullable = false, length = 64)
    val toStopId: String,
