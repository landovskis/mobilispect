 ...
 *
 * The reader processes variants sequentially, yielding one FrequencyInput at a time.
...
class FrequencyReader(
    ...
    private var variantIterator: Iterator<Map.Entry<RouteVariant, List<ParsedTrip>>>? = null
    ...
    fun beforeStep(stepExecution: StepExecution) {
        ...
        logger.info(
            "Initializing FrequencyReader with {} trips from GTFS data",
            data.trips.size
        )
        ...
        val variantMap = persistedVariants.associateWith { variant ->
