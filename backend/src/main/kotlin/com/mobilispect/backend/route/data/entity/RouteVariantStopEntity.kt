 ...
 *
 * Represents the combination of variant_id and stop_sequence that uniquely identifies
 * a stop position within a route variant.
 */
@Embeddable
 ...
 *
 * Links route variants to their ordered stop sequences, enabling normalized queries
 * like "find all variants serving stop X" while maintaining denormalized stop patterns
 * in route_variants table for display performance.
 */
@Entity
@Table(name = "route_variant_stops")
class RouteVariantStopEntity(
    @EmbeddedId
    val id: RouteVariantStopId,
