 ...
 *
 * These periods are used to segment frequency data and allow for
 * period-specific analysis of service patterns and headway variations.
 *
    ...
    companion object {
        ...
        fun fromValue(value: String): TimePeriod {
            return entries.find { it.value == value }
                ?: throw IllegalArgumentException("Unknown TimePeriod value: $value. Valid values: ${entries.joinToString { it.value }}")
        }
    }
}
