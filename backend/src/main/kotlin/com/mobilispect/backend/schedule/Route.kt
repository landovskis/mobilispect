...
data class Route(
  ...
  init {
    require(uid.matches(ROUTE_ONESTOP_ID_REGEX)) {
      "Route id must be of the form r-geohash-id, Was $uid"
    }
    ...
    require(agencyID.matches(AGENCY_ONESTOP_ID_REGEX)) {
      "Agency ID must be of the form o-geohash-id, Was $agencyID"
    }
