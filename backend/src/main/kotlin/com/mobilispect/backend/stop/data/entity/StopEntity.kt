 ...
 * domain layer uses Stop with type-safe StopId value class.
 */
@Entity
@Table(name = "stops")
class StopEntity(
  ...
  @Column(name = "gtfs_stop_id", nullable = false, length = 255) val gtfsStopId: String,
  @Column(name = "name", nullable = false, length = 255) var name: String,
  @Column(name = "latitude", nullable = false) var latitude: Double,
  @Column(name = "longitude", nullable = false) var longitude: Double,
  @Column(name = "stop_code", length = 50) var stopCode: String? = null,
  @Column(name = "stop_desc", columnDefinition = "TEXT") var stopDesc: String? = null,
  @Column(name = "zone_id", length = 50) var zoneId: String? = null,
  @Column(name = "stop_url", length = 512) var stopUrl: String? = null,
  @Column(name = "location_type") var locationType: Int? = null,
  @Column(name = "parent_station", length = 255) var parentStation: String? = null,
