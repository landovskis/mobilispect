...
class StopQueryService(private val stopRepository: StopRepository) {
  ...
  @Cacheable(
    ...
    key = "'feed_stops_' + #feedId + '_' + #pageable.pageNumber",
  )
  ...
  @Cacheable(
    value = [RedisConfiguration.Companion.FREQUENCY_CACHE],
    key = "'feed_active_stops_' + #feedId + '_' + #pageable.pageNumber",
  )
  ...
  @Cacheable(
    value = [RedisConfiguration.Companion.FREQUENCY_CACHE],
    key = "'feed_stations_' + #feedId + '_' + #pageable.pageNumber",
  )
  ...
  @Cacheable(
    value = [RedisConfiguration.Companion.FREQUENCY_CACHE],
    key = "'feed_active_stop_count_' + #feedId",
  )
