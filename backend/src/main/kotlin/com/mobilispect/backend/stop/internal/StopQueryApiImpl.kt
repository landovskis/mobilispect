 ...
 *
 * Bridges the Stop module API to the underlying repository layer. This implementation is internal
 * to the stop module and should not be accessed directly by other modules.
 */
@Component
internal class StopQueryApiImpl(private val stopRepository: StopRepository) : StopQueryApi {
  ...
  override fun validateStopExists(stopId: StopId): Boolean = stopRepository.findById(stopId) != null
}
