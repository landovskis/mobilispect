...
export class ImportService implements OnDestroy {
  ...
  startImport(feedId: string, request?: ImportRequest): Observable<FeedImport> {
    ...
    return this.http
      .post<FeedImport>(`${this.apiUrl}/${feedId}/import`, body)
      .pipe(
        tap(() => {
  ...
  getFeedImportHistory(
    ...
    return this.http
      .get<
        ImportsResponse<FeedImport>
      >(`${this.apiUrl}/${feedOnestopId}/imports`, { params })
      .pipe(
        map((response) => ({
  ...
  getAllImportHistory(options?: {
    ...
    return this.http
      .get<
        ImportsResponse<FeedImportSummary>
      >(`${this.apiUrl}/imports`, { params })
      .pipe(
        map((response) => ({
          imports: response.imports,
          totalElements: response.page.totalElements,
   ...
   */
  getRecentImports(limit = 50): Observable<FeedImportSummary[]> {
   ...
   */
  getFailedImports(): Observable<FeedImportSummary[]> {
