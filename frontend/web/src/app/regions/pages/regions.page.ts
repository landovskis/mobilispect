...
@Component({
  ...
  template: `
    <div class="regions-container master-detail-layout" [class.has-selection]="selectedRegion$ | async">
    ...
    this.route.queryParamMap
      ...
      .subscribe(queryParams => {
        ...
        if (regionIdFromQuery && !this.route.snapshot.paramMap.get('regionId')) {
          ...
          this.router.navigate(['/regions', regionIdFromQuery], { replaceUrl: true });
        }
      });
  }
