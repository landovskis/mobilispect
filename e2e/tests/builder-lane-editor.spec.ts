 ...
 * on the same page, so the side panel's DOM nodes are reused rather than
 * remounted, matching what happens when an analyst clicks from one
 * cross-section straight to another.
 */
